          ...
          <div className="flex flex-col-reverse flex-wrap gap-8 md:flex-row md:flex-nowrap md:justify-between xl:gap-20">
            ...
            >
              ...
              <div className="5 mb-7">
                ...
                <p>Achieve your fitness goals with personalized coaching tailored to your needs. Whether you're looking to build muscle, lose weight, or improve your overall health, our expert trainers are here to guide you every step of the way. With customized workout plans, nutritional advice, and ongoing support, we’ll help you stay motivated and on track to reach your full potential. Sign up today and take the first step toward a stronger, healthier, and more confident you!</p>
              </div>
            </motion.div>
          </div>
        </div>
